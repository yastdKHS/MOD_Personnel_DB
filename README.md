...
- [`docs/phase7-integration-design.md`](docs/phase7-integration-design.md) — **Phase7 Integration Design**。Phase7実装済み4パッケージをComposition Root（`cli/`）へ統合するための設計（Task17-0で設計確定、実装は未着手）
