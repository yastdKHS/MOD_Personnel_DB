...
class StandardFTPClient:
    ...
    def connect(self) -> None:
        ...
        connection.set_debuglevel(2)  # DEBUG(Task18-21)
        try:
            ...
            if self._config.remote_directory:
                print(f"remote_directory={self._config.remote_directory!r}")  # DEBUG(Task18-21)
                connection.cwd(self._config.remote_directory)
                print(f"PWD={connection.pwd()!r}")  # DEBUG(Task18-21)
    ...
    def download(self, remote_path: str, local_path: str) -> None:
        ...
        connection = self._require_connection()
        try:
            print(f"remote_path={remote_path!r}")  # DEBUG(Task18-21)
